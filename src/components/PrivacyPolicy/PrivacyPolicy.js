  ...
  return (
    <Fragment>
      <section className="privacy-policy container">
        ...
        <br />
        <p>At Jacint Udvarlaki portfolio, accessible from jacint-udvarlaki.co.uk., one of our 
          main priorities is the privacy of our visitors. This Privacy Policy document contains 
          types of information that is collected and recorded by Jacint Udvarlaki portfolio and 
          how we use it.</p>
        ...
        <p>This Privacy Policy applies only to our online activities and is valid for visitors 
          ...
          Jacint Udvarlaki portfolio. This policy is not applicable to any information collected 
        ...
        <p>Jacint Udvarlaki portfolio follows a standard procedure of using log files. These 
        ...
        <p>You may consult this list to find the Privacy Policy for each of the advertising 
          partners of Jacint Udvarlaki portfolio.</p>
        ...
        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or 
          ...
          Jacint Udvarlaki portfolio, which are sent directly to users' browser. They 
        ...
        <p>Note that Jacint Udvarlaki portfolio has no access to or control over these cookies 
          that are used by third-party advertisers.</p>

        <h2>Third Party Privacy Policies</h2>

        <p>Jacint Udvarlaki portfolio's Privacy Policy does not apply to other advertisers or 
        ...
        <p>Jacint Udvarlaki portfolio does not knowingly collect any Personal Identifiable 
