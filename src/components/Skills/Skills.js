        ...
        <section id="skills" className="skills section-bg">
          <div className="container">
            ...
            <div className="row skills-content">
              ...
              <div className="card col-sm-6 col-md-4 col-lg-2" data-aos="fade-up" data-aos-delay="50">
              ...
              <div className="card col-sm-6 col-md-4 col-lg-2" data-aos="fade-up" data-aos-delay="150">
                <img src={javaScriptIcon} className="card-img-top" alt="JavaScript-icon" />
                <div className="card-body">
                  <p className="card-text">JavaScript</p>
                </div>
              </div>

              <div className="card col-sm-6 col-md-4 col-lg-2" data-aos="fade-up" data-aos-delay="200">
              ...
              <div className="card col-sm-6 col-md-4 col-lg-2" data-aos="fade-up" data-aos-delay="250">
              ...
              <div className="card col-sm-6 col-md-4 col-lg-2" data-aos="fade-up" data-aos-delay="300">
                <img src={bootstrapIcon} className="card-img-top" alt="Bootstrap-icon" />
                <div className="card-body">
            ...
            <div className="row">
              ...
              <div className="card col-sm-6 col-md-4 col-lg-2" data-aos="fade-up" data-aos-delay="350">
              ...
              <div className="card col-sm-6 col-md-4 col-lg-2" data-aos="fade-up" data-aos-delay="400">
              ...
              <div className="card col-sm-6 col-md-4 col-lg-2" data-aos="fade-up" data-aos-delay="450">
                <img src={laravelIcon} className="card-img-top" alt="Laravel-icon" />
                <div className="card-body">
                  <p className="card-text">Laravel</p>
                </div>
              </div>

              <div className="card col-sm-6 col-md-4 col-lg-2" data-aos="fade-up" data-aos-delay="500">
              ...
              <div className="card col-sm-6 col-md-4 col-lg-2" data-aos="fade-up" data-aos-delay="550">
                <img src={vscIcon} className="card-img-top" alt="Visual Studio Code-icon" />
                <div className="card-body">
                  <p className="card-text">Visual Studio Code</p>
                </div>
              </div>

              <div className="card col-sm-6 col-md-4 col-lg-2" data-aos="fade-up" data-aos-delay="600">
                <img src={photoshopIcon} className="card-img-top" alt="Photoshop-icon" />
                <div className="card-body">
