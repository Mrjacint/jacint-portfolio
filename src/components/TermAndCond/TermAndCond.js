...
const TermAndCond = () => {
  return (
    <Fragment>
      <section className="termandcond container">
        <div className="section-title">
          <h2><strong>Terms and Conditions</strong></h2>
        </div>
        
        <h5>Welcome to Jacint Udvarlaki portfolio!</h5>
        <br />
        <p>These terms and conditions outline the rules and regulations for the use of 
          jacint-udvarlaki.co.uk's Website, located at jacint-udvarlaki.co.uk.</p>
  
        <p>By accessing this website we assume you accept these terms and conditions.
           Do not continue to use Jacint Udvarlaki portfolio if you do not agree to take 
           all of the terms and conditions stated on this page. Our Terms and Conditions 
           ...
           <a href="https://www.privacypolicyonline.com/terms-conditions-generator/">
             Free Terms & Conditions Generator</a>.</p>
        ...
        <p>We employ the use of cookies. By accessing Jacint Udvarlaki portfolio, 
          you agreed to use cookies in agreement with the jacint-udvarlaki.co.uk's Privacy Policy.</p>
        ...
        <p>Unless otherwise stated, jacint-udvarlaki.co.uk and/or its licensors own the intellectual 
          property rights for all material on Jacint Udvarlaki portfolio. All intellectual property 
          rights are reserved. You may access this from Jacint Udvarlaki portfolio for your own 
          personal use subjected to restrictions set in these terms and conditions.</p>
  
        <p>You must not:</p>
        <ul>
            <li>Republish material from Jacint Udvarlaki portfolio</li>
            <li>Sell, rent or sub-license material from Jacint Udvarlaki portfolio</li>
            <li>Reproduce, duplicate or copy material from Jacint Udvarlaki portfolio</li>
            <li>Redistribute content from Jacint Udvarlaki portfolio</li>
        </ul>
  
        <p>This Agreement shall begin on the date hereof.</p>
  
        <p>Parts of this website offer an opportunity for users to post and exchange opinions 
          and information in certain areas of the website. jacint-udvarlaki.co.uk does not filter, 
          edit, publish or review Comments prior to their presence on the website. Comments do not 
          reflect the views and opinions of jacint-udvarlaki.co.uk,its agents and/or affiliates. 
          Comments reflect the views and opinions of the person who post their views and opinions. 
          To the extent permitted by applicable laws, jacint-udvarlaki.co.uk shall not be liable 
        ...
        <p>jacint-udvarlaki.co.uk reserves the right to monitor all Comments and to remove any Comments 
        ...
        <p>You hereby grant jacint-udvarlaki.co.uk a non-exclusive license to use, reproduce, edit 
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link 
          ...
          visibility of the hyperlink compensates the absence of jacint-udvarlaki.co.uk; and (d) 
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in 
          linking to our website, you must inform us by sending an e-mail to jacint-udvarlaki.co.uk. 
        ...
        <p>No use of jacint-udvarlaki.co.uk's logo or other artwork will be allowed for linking absent 
        ...
        <p>The limitations and prohibitions of liability set in this Section and elsewhere in 
          this disclaimer: (a) are subject to the preceding paragraph; and (b) govern all liabilities 
