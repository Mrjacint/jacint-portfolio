      ...
      <div className="d-flex flex-column">
        <div className="profile">
          ...
          <h1 className="text-light">
            <a href="index.html">Jacint Udvarlaki </a>
          </h1>
          <div className="social-links mt-3 text-center">
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.facebook.com/jacint.udvarlaki"
              className="facebook"
            >
            ...
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.instagram.com/jacintudvarlaki"
              className="instagram"
            >
            ...
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://github.com/Mrjacint"
              className="github"
            >
            ...
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.linkedin.com/in/jacint-udvarlaki"
              className="linkedin"
            >
        ...
        <nav className="nav-menu">
          <ul>
            ...
            <li className={props.elmclass === "about" ? "active" : ""}>
              <a href="/#about">
            ...
            <li className={props.elmclass === "contact" ? "active" : ""}>
              <a href="/#contact">
